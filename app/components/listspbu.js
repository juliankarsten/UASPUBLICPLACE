...
export default class Boiler extends Component {
  ...
  this.itemsRef = firebase.database().ref('spbu');
  ...
  renderRow(item){
    return(
      ...
      <Image source={require('./spbu.png')} style={{width : 100 , height : 100}}>
      </Image>
  ...
  render() {
    ...
    <View style={styles.container}>
            ...
            />
            {/* <ListItem onPress={() => this.props.navigation.navigate("detailspbu")}>
            ...
            <ListItem onPress={() => this.props.navigation.navigate("detailspbu") }>
              <Thumbnail style={{ marginRight:'2%'}} source={require('./spbu.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} >SPBU 1</Text>
              </Body>
            </ListItem>
            <ListItem onPress={() => this.props.navigation.navigate("detailspbu") }>
              <Thumbnail style={{ marginRight:'2%'}} source={require('./spbu.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} >SPBU 2</Text>
              </Body>
            </ListItem>
            <ListItem onPress={() => this.props.navigation.navigate("detailspbu") }>
              <Thumbnail style={{ marginRight:'2%'}} source={require('./spbu.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} >SPBU 3</Text>
              </Body>
            </ListItem>
            <ListItem onPress={() => this.props.navigation.navigate("detailspbu") }>
              <Thumbnail stle={{ marginRight:'2%'}} source={require('./spbu.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} > SPBU 4</Text>
              </Body>
            </ListItem>
            <ListItem onPress={() => this.props.navigation.navigate("detailspbu") }>
              <Thumbnail stle={{ marginRight:'2%'}} source={require('./spbu.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} >SPBU 5</Text>
              </Body>
            </ListItem> */}
  </View>
    );
...
AppRegistry.registerComponent("listspbu", () => listspbu);