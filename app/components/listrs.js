...
export default class Boiler extends Component {
  ...
  render() {
    ...
    <View style={styles.container}>
            ...
            />
            {/* <ListItem onPress={() => this.props.navigation.navigate("detailrs")}>
            ...
            <ListItem onPress={() => this.props.navigation.navigate("detailrs") }>
              <Thumbnail style={{ marginRight:'2%'}} source={require('./rumahsakit.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} >rumah sakit 1</Text>
              </Body>
            </ListItem>
            <ListItem onPress={() => this.props.navigation.navigate("detailrs") }>
              <Thumbnail style={{ marginRight:'2%'}} source={require('./rumahsakit.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} >rumah sakit 2</Text>
              </Body>
            </ListItem>
            <ListItem onPress={() => this.props.navigation.navigate("detailrs") }>
              <Thumbnail style={{ marginRight:'2%'}} source={require('./rumahsakit.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} >rumah sakit 3</Text>
              </Body>
            </ListItem>
            <ListItem onPress={() => this.props.navigation.navigate("detailrs") }>
              <Thumbnail stle={{ marginRight:'2%'}} source={require('./rumahsakit.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} > rumah sakit 4</Text>
              </Body>
            </ListItem>
            <ListItem onPress={() => this.props.navigation.navigate("detailrs") }>
              <Thumbnail stle={{ marginRight:'2%'}} source={require('./rumahsakit.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} >rumah sakit 5</Text>
              </Body>
            </ListItem> */}
 </View>
    );
...
AppRegistry.registerComponent("listrs", () => listrs);