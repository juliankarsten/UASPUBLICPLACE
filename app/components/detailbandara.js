  ...
  render() {
    ...
    return (      
       <Container style={{backgroundColor:'white'}}>
          ...
          <Image source={require('./bandara.png')} style={{width:width, height:200}} />
          </View>
        <Content>
        <ListItem>
          <Body>
        ...
        <ListItem>
          ...
          <View style={{flexDirection:'row'}}>
            <Text style={{fontSize:15, marginTop:'1%', marginLeft:'2%'}} >bandara.com</Text>
          </View>
          </Body>
        </ListItem>
        </Content>
...
AppRegistry.registerComponent("detailbandara", () => detailbandara);