...
export default class Boiler extends Component {
  ...
  this.itemsRef = firebase.database().ref('bandara');
  ...
  renderRow(item){
    return(
      ...
      <Image source={require('./bandara.png')} style={{width : 100 , height : 100}}>
      </Image>
  ...
  render() {
    ...
    <View style={styles.container}>
            ...
            />
            {/* <ListItem onPress={() => this.props.navigation.navigate("detailbandara")}>
            ...
            <ListItem onPress={() => this.props.navigation.navigate("detailbandara") }>
              <Thumbnail style={{ marginRight:'2%'}} source={require('./bandara.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} >bandara 1</Text>
              </Body>
            </ListItem>
            <ListItem onPress={() => this.props.navigation.navigate("detailbandara") }>
              <Thumbnail style={{ marginRight:'2%'}} source={require('./bandara.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} >bandara 2</Text>
              </Body>
            </ListItem>
            <ListItem onPress={() => this.props.navigation.navigate("detailbandara") }>
              <Thumbnail style={{ marginRight:'2%'}} source={require('./bandara.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} >bandara 3</Text>
              </Body>
            </ListItem>
            <ListItem onPress={() => this.props.navigation.navigate("detailbandara") }>
              <Thumbnail stle={{ marginRight:'2%'}} source={require('./bandara.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} > bandara 4</Text>
              </Body>
            </ListItem>
            <ListItem onPress={() => this.props.navigation.navigate("detailbandara") }>
              <Thumbnail stle={{ marginRight:'2%'}} source={require('./bandara.png')}/>
              <Body style={{marginRight:'2%'}}>
                <Text style={{fontWeight:'bold', fontSize:18}} >bandara 5</Text>
              </Body>
            </ListItem> */}
  </View>
    );
...
AppRegistry.registerComponent("listbandara", () => listbandara);