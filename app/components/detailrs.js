  ...
  render() {
    ...
    return (      
       <Container style={{backgroundColor:'white'}}>
          ...
          <Image source={require('./rumahsakit.png')} style={{width:width, height:200}} />
          </View>
        <Content>
        <ListItem>
          <Body>
        ...
        <ListItem>
          ...
          <View style={{flexDirection:'row'}}>
            <Text style={{fontSize:15, marginTop:'1%', marginLeft:'2%'}} >kasihibu.com</Text>
          </View>
          </Body>
        </ListItem>
        </Content>
...
AppRegistry.registerComponent("detailrs", () => detailrs);